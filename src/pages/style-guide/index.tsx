            ...
            <div className="row narrow add-bottom text-center">
                ...
                <div className="col-six tab-full">		                  
                    ...
                    <h3>Buttons</h3>
                        ...
                        <p>
                            <Link className="button button-primary full-width" href="#">Primary Button</Link>
                            <Link className="button full-width" href="#">Default Button</Link>
                        </p>
                ...
                <div className="col-twelve">
                    ...
                    <ul className="stats-tabs">
                        <li><Link href="#">1,234 <em>Sasuke</em></Link></li>
                        <li><Link href="#">567 <em>Hinata</em></Link></li>
                        <li><Link href="#">23,456 <em>Naruto</em></Link></li>
                        <li><Link href="#">3,456 <em>Kiba</em></Link></li>
                        <li><Link href="#">456 <em>Shikamaru</em></Link></li>
                        <li><Link href="#">26 <em>Sakura</em></Link></li>
                        </ul>	      		
